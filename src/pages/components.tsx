            ...
            <ol className='mt-8 space-y-6'>
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  ...
                  <ButtonLink href='https://github.com/thienjs/thien.app/blob/main/src/styles/colors.css'>
              ...
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnstyledLink href='https://thien.app'>
                    Outside Links
                  </UnstyledLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <PrimaryLink href='https://thien.app'>
                    Outside Links
                  </PrimaryLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnderlineLink href='https://thien.app'>
                    Outside Links
                  </UnderlineLink>
                </div>
              </li>
